...
export default function Home() {
  ...
  const groupedEvents = categories.reduce(
    (acc: Record<string, Event[]>, category) => {
      acc[category] =
        category === "All"
          ? filteredEvents
  ...
  return (
    <main className="px-6 mt-30  mx-auto">
      {/* Hero Section */}
      <section className="relative text-center lg:mt-20 mb-4 md:mb-10 py-16 sm:py-32 px-6 text-white rounded-3xl shadow-xl overflow-hidden z-0">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight drop-shadow-lg">
            Feel the Music.
            <br className="hidden sm:block" />
            Live the Experience.
          </h1>
          <p className="text-lg sm:text-2xl max-w-2xl mx-auto font-light drop-shadow-md">
            Discover and book tickets to the hottest concerts around you –
            electrify your nights, all in one place.
          </p>
      ...
      <div className=" flex lg:mx-24 flex-col">
