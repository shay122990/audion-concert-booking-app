  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16">
      ...
      >
        {selectedBooking && (
          <>
            <p className="font-semibold text-lg">{selectedBooking.title}</p>
            <p className="text-sm text-gray-500 mb-2">📅 {selectedBooking.selectedDate}</p>
            <p className="text-sm text-gray-500 mb-2">📍 {selectedBooking.location}</p>
            <hr className="my-4" />
            <p className="text-xs text-gray-400">Booking Ref: {selectedBooking.id}</p>
            <p className="text-xs text-gray-400">
              Booked on: {new Date(selectedBooking.bookedAt).toLocaleDateString()}
            </p>
          </>
        )}
      </Modal>
