...
export default function EventDetailsPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 sm:px-6 py-16 mt-6 lg:mt-16">
      <div className="grid lg:grid-cols-2  items-start gap-10">
        <div className="flex flex-col justify-between h-full space-y-10">
          <div className="relative w-full h-80 rounded-2xl overflow-hidden shadow-xl border border-gray-200 dark:border-gray-800">
            <Image
              src={event.image}
              alt={event.title}
              fill
          ...
          {event.lineup?.length > 0 && (
            <div>
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-white shadow-sm">
        ...
        <div className="flex flex-col justify-between h-full space-y-6">
          <div>
            ...
            <div className="space-y-1 text-sm text-gray-500 dark:text-gray-400 mt-4">
              <p>📍 {event.location}</p>
              <p>
                🕗 Doors Open: {event.doorsOpenTime} | Starts: {event.startTime}{" "}
                | Ends: {event.endTime}
              </p>
